...
const achievements = [
  {
    ...
    imageUrl: "assets/InstaPost/post-1.jpg",
  },
  {
    id: 2,
    title: "Top Sports Team",
    imageUrl: "assets/InstaPost/achi2.jpg",
  },
  {
    id: 3,
    title: "Innovative Research Grant",
    imageUrl: "assets/InstaPost/award.jpg",
  },
  {
    id: 4,
    title: "International Dental Conference",
    imageUrl: "assets/InstaPost/achi3.jpg",
  },
];
...
function AchievementSection() {
  ...
  return (
    <section className="bg-gradient-to-r from-blue-50 to-white py-16 px-6 md:px-16">
